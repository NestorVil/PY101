...
# Alyssa supplied Ben with a function named is_an_ip_number. It determines whether a 
# string is a numeric string between 0 and 255 as required for IP numbers and asked Ben to use it. Here's the code that Ben wrote:
